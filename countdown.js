let date = new Date("2022-04-8-8-30-0");
let start = Date.now();
let timeLeft = date-start

let hours = timeLeft.getHours(); // starting number of hours
let minutes = timeLeft.getMinutes(); // starting number of minutes
let seconds = timeLeft.getSeconds(); // starting number of seconds
